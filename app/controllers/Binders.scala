...
import models.{ObligationsQueryParams, OptEither}
...
object Binders {
  ...
  implicit def obligationsQueryParamsBinder(implicit stringBinder: QueryStringBindable[String])
  : QueryStringBindable[ObligationsQueryParams] =
    new QueryStringBindable[ObligationsQueryParams] {
      ...
      override def unbind(key: String, value: ObligationsQueryParams): String = {
